...
const RecentWorksEach = ({img, title, about, id}:RecentWorksEachProps) => {
    return(
        <>
        <Link id="eachWork" href={`/project/${id}`} className="md:w-[48%] w-full h-auto relative bg-black rounded-2xl">
            ...
            <div className="absolute bottom-0 p-1 transition duration-300 opacity-0">
              <div className="bg-purple-600 shadow-lg md:p-5 p-4 text-white rounded-2xl">
